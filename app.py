...
from actions import (index_action, login_action, do_login_action, main_calendar_action, admin_calendar_action, new_task_action,
...
app.add_url_rule("/admin/<calendar_id>/", "admin_calendar_action", admin_calendar_action, methods=["GET"])
